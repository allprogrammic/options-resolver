...
namespace AllProgrammic\Component\OptionsResolver\Tests;

use PHPUnit\Framework\Assert;
use PHPUnit\Framework\TestCase;
use AllProgrammic\Component\OptionsResolver\Exception\InvalidOptionsException;
use AllProgrammic\Component\OptionsResolver\Options;
use AllProgrammic\Component\OptionsResolver\OptionsResolver;
...
class OptionsResolverTest extends TestCase
{
    ...
    /**
     * @expectedException \AllProgrammic\Component\OptionsResolver\Exception\UndefinedOptionsException
    ...
    /**
     * @expectedException \AllProgrammic\Component\OptionsResolver\Exception\AccessException
     */
    ...
    /**
     * @expectedException \AllProgrammic\Component\OptionsResolver\Exception\MissingOptionsException
     */
    ...
    public function testResolveFailsIfInvalidType($actualType, $allowedType, $exceptionMessage)
    {
        ...
        if (method_exists($this, 'expectException')) {
            $this->expectException('AllProgrammic\Component\OptionsResolver\Exception\InvalidOptionsException');
            $this->expectExceptionMessage($exceptionMessage);
        } else {
            $this->setExpectedException('AllProgrammic\Component\OptionsResolver\Exception\InvalidOptionsException', $exceptionMessage);
        }
    ...
    public function provideInvalidTypes()
    {
        return array(
            ...
            array(new OptionsResolver(), 'string', 'The option "option" with value AllProgrammic\Component\OptionsResolver\OptionsResolver is expected to be of type "string", but is of type "AllProgrammic\Component\OptionsResolver\OptionsResolver".'),
    ...
    /**
     * @expectedException \AllProgrammic\Component\OptionsResolver\Exception\InvalidOptionsException
    ...
    /**
     * @expectedException \AllProgrammic\Component\OptionsResolver\Exception\OptionDefinitionException
     */
    ...
    /**
     * @expectedException \AllProgrammic\Component\OptionsResolver\Exception\NoSuchOptionException
